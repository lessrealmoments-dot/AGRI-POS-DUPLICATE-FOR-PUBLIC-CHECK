...
- A small expandable section "Advanced: Server URL" containing:
  ...
  - Text field: "Preview/Custom URL (optional)" — pre-filled with empty, hint: "https://zreport-adjustments.preview.emergentagent.com"
  - "Save URL" button
...
5. The app should be tested with the server at `https://zreport-adjustments.preview.emergentagent.com` during development — this URL should be the default text in the "Preview URL" field in settings.
