...
**Line:** `public static final String SERVER_PREVIEW = "https://balance-diagnostic.preview.emergentagent.com";`
...
**The fix:**
```java
public static final String SERVER_PREVIEW = "https://balance-diagnostic.preview.emergentagent.com";
```
...
2. Open the app → Settings → set URL to `https://balance-diagnostic.preview.emergentagent.com` → login.
