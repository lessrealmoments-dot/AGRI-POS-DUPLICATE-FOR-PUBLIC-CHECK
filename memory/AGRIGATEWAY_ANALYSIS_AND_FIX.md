...
**Line:** `public static final String SERVER_PREVIEW = "https://agribooks-pos.preview.emergentagent.com";`

**The bug:** This hardcoded preview URL doesn't match the actual server. The correct current preview URL is:
`https://agribooks-pos.preview.emergentagent.com`

**The fix:**
```java
public static final String SERVER_PREVIEW = "https://agribooks-pos.preview.emergentagent.com";
```
...
2. Open the app → Settings → set URL to `https://agribooks-pos.preview.emergentagent.com` → login.
