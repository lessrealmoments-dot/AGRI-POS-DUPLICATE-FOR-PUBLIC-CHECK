...
**Line:** `public static final String SERVER_PREVIEW = "https://draft-audit-pulse.preview.emergentagent.com";`

**The bug:** This hardcoded preview URL doesn't match the actual server. The correct current preview URL is:
`https://draft-audit-pulse.preview.emergentagent.com`

**The fix:**
```java
public static final String SERVER_PREVIEW = "https://draft-audit-pulse.preview.emergentagent.com";
```
...
2. Open the app → Settings → set URL to `https://draft-audit-pulse.preview.emergentagent.com` → login.
