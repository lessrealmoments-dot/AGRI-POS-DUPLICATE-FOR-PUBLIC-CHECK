...
**Line:** `public static final String SERVER_PREVIEW = "https://phase4a-frontend.preview.emergentagent.com";`
...
**The fix:**
```java
public static final String SERVER_PREVIEW = "https://phase4a-frontend.preview.emergentagent.com";
```
...
2. Open the app → Settings → set URL to `https://phase4a-frontend.preview.emergentagent.com` → login.
