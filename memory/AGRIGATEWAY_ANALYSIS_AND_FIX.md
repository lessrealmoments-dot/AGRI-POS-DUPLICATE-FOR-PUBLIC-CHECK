...
**Line:** `public static final String SERVER_PREVIEW = "https://hc-decompose.preview.emergentagent.com";`
...
**The fix:**
```java
public static final String SERVER_PREVIEW = "https://hc-decompose.preview.emergentagent.com";
```
...
2. Open the app → Settings → set URL to `https://hc-decompose.preview.emergentagent.com` → login.
