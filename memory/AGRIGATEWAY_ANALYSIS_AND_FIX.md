...
**Line:** `public static final String SERVER_PREVIEW = "https://permission-lockdown-1.preview.emergentagent.com";`
...
**The fix:**
```java
public static final String SERVER_PREVIEW = "https://permission-lockdown-1.preview.emergentagent.com";
```
...
2. Open the app → Settings → set URL to `https://permission-lockdown-1.preview.emergentagent.com` → login.
