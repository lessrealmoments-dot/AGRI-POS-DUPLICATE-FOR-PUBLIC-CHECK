...
**Line:** `public static final String SERVER_PREVIEW = "https://pin-gating-inventory.preview.emergentagent.com";`

**The bug:** This hardcoded preview URL doesn't match the actual server. The correct current preview URL is:
`https://pin-gating-inventory.preview.emergentagent.com`

**The fix:**
```java
public static final String SERVER_PREVIEW = "https://pin-gating-inventory.preview.emergentagent.com";
```
...
2. Open the app → Settings → set URL to `https://pin-gating-inventory.preview.emergentagent.com` → login.
