...
**Line:** `public static final String SERVER_PREVIEW = "https://supplier-ledger-view.preview.emergentagent.com";`
...
**The fix:**
```java
public static final String SERVER_PREVIEW = "https://supplier-ledger-view.preview.emergentagent.com";
```
...
2. Open the app → Settings → set URL to `https://supplier-ledger-view.preview.emergentagent.com` → login.
