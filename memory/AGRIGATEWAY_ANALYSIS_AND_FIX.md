...
**Line:** `public static final String SERVER_PREVIEW = "https://pos-bugfix-sprint.preview.emergentagent.com";`
...
**The fix:**
```java
public static final String SERVER_PREVIEW = "https://pos-bugfix-sprint.preview.emergentagent.com";
```
...
2. Open the app → Settings → set URL to `https://pos-bugfix-sprint.preview.emergentagent.com` → login.
